       ...
       <div class="container">
           ...
           <div class="row">
               ...
               <div class="col-sm-3">
                   ...
                   <img src="image/kare.jpg" class="img-thumbnail" alt="中華料理"/>
                   <h3>上等カレー</h3>
                   <p>専門カレー屋</p>　おすすめ度<>
                   <p><a href="ac.html" class="btn btn-success" role="button">場所</a>
                   <a href="jtkrEST.php" class="btn btn-success" role="button">評価</a></p>
               </div>
               <div class="col-sm-3">
                   <img src="image/danwan.jpg	" class="img-thumbnail" alt="日本料理" />
                   <h3>伝丸 百万遍店</h3>
                   <p>専門ラーメン屋</p>
                   <p><a href="danwan.html" class="btn btn-success" role="button">場所</a>
                   <a href="danwan.php" class="btn btn-success" role="button">評価</a></p>
               </div>
           ...
           <div class="row">
               ...
               <div class="col-sm-3">
                   <img src="Images/中华料理.jpg" class="img-circle" alt="ファ—スト．フ—ド販売" />
                   <h3>中華料理</h3>
                   <p>中華料理を一覧に示す</p>
