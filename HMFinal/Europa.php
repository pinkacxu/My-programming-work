       ...
       <div class="container">
           ...
           <div class="row">
               ...
               <div class="col-sm-3">
                   ...
                   <img src="image/kicty.jpg" class="img-thumbnail" alt="中華料理"/>
                   <h3>キッチン瑞穂 </h3>
                   <p>きっちんみずほ</p>　
                   <p><a href="kicty.html" class="btn btn-success" role="button">場所</a>
                   <a href="kicty.php" class="btn btn-success" role="button">評価</a></p>
               </div>
               <div class="col-sm-3">
                   <img src="image/james.jpg" class="img-thumbnail" alt="日本料理" />
                   <h3>ジェイムスキッチン</h3>
                   <p>James Kitchen</p>
                   <p><a href="james.html" class="btn btn-success" role="button">場所</a>
                   <a href="james.php" class="btn btn-success" role="button">評価</a></p>
               </div>
           ...
           <div class="row">
               <div class="col-sm-3">
                   ...
                   <img src="Images/中华料理.jpg"  class="img-circle" alt="ヨーロッパ料理"/>
                   <h3>中華料理</h3>
                   <p>中華料理を一覧に示す</p>
